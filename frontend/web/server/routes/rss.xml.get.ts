...
export default defineEventHandler(async (event) => {
  ...
  return `<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>Wineclouds’Blog</title><link>${escapeXml(siteUrl)}</link><description>记录技术、生活与灵光的个人博客。</description><language>zh-CN</language>${items}</channel></rss>`
})
